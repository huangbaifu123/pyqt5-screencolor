...
from PyQt5.QtCore import QObject, QUrl, Qt, pyqtSlot, pyqtSignal, QRect, QPoint
...
class ScreenColorWindow (QtWidgets.QWidget):
    ...
    def timerThisWin(self):
        ...
        self.detile_view.flushImage(QRect(QPoint(curX - 25, curY - 25), QPoint(curX + 25, curY + 25)))
...
class SetPathWindow(QLabel):
    ...
    def initUi(self):
        ...
        # self.move(500, 350)
        QImg = QImage(self)
    def flushImage(self, rect):
        QsImg = QImage(self)
        QsImg.load("screen_test.png", "png")
        QImg = QsImg.copy(rect)
